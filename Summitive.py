...
def main():
    ...
    while True:
        main_menu(screen)  # Start with the main menu
        ...
        # Entities
        # Create Background
        background = pygame.transform.scale(pygame.image.load('./img/bg.jpg'), (1920, 1080))  # Scale background
        ...
        # Create the sprites
        # Create the player and set its position to the center of the screen
        player = sprite_module.Player(screen)
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_ESCAPE:
                        pause_menu(screen)  # Open the pause menu when ESC is pressed
                    elif event.key == pygame.K_p:
                        pause_menu(screen)  # Open the pause menu when P is pressed
